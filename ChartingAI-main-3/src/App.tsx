...
import TranscriptTools from "./pages/TranscriptTools";

const queryClient = new QueryClient();

const App = () => (
  <ThemeProvider defaultTheme="light" storageKey="chartingai-ui-theme">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/profile" element={<ProfilePage />} />
            ...
            <Route path="/transcript-tools" element={<TranscriptTools />} />
