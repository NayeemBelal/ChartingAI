...
// import { CheckCircle, ChevronRight, Mic } from "lucide-react";
// import { useState } from "react";

// // This page = Charting AI dashboard
// // User lands here after clicking "Open" in the Marketplace card.
...
//   // for small inline state to pretend a file is staged
//   const [hasUploadStaged, setHasUploadStaged] = useState(false);

//   function handlePrimaryAction() {
//     // In v1, we're treating this as:
//     // "submit audio → transcription job started → go to success screen"
//     navigate("/success");
//   }

//   function handleSelectFile() {
//     // This is where you'd open file picker, capture file, etc.
//     // We'll just flip a flag for visual feedback.
//     setHasUploadStaged(true);
//   }

//   function handleOpenEncounter(enc: (typeof recent)[number]) {
//     // Eventually: finalized -> `/finalize/:id`, draft -> `/chart/:id`
//     // For now you can still reuse success to preview output,
//     // or branch if you want. We'll branch for clarity.
//     if (enc.tone === "finalized") {
//       navigate("/success"); // placeholder
//     } else {
//       navigate("/success"); // placeholder
//     }
//   }
...
//       style={{
//         backgroundColor: "#f9fafb", // light clinic gray
//       }}
//     >
//       {/* ---------- TOP HEADER / NAV ---------- */}
...
//           {/* Right side: user chip / placeholder */}
//           <div className="flex items-center md:pt-2">
//             <div className="h-8 px-3 rounded-full border border-neutral-300 bg-white text-[13px] text-neutral-700 hover:bg-neutral-50 cursor-pointer">
//               DR
//             </div>
//           </div>
//         </div>
...
//             style={{
//               borderColor: "#d0d5dd", // neutral-300 border tone
//             }}
//           >
//             {/* card header */}
...
//                   <>
//                     <div className="h-12 w-12 rounded-full border border-neutral-300 bg-white flex items-center justify-center mb-4">
//                       {/* we reuse Mic here for the visual / you could do Upload icon */}
...
//                       className="mt-4 text-[13px] font-medium text-blue-700 hover:underline"
//                       style={{ color: "#2f59b0" }}
//                     >
//                       Browse files
//                     </button>
...
//                   style={{
//                     backgroundColor: "#97b7ff", // soft blue
//                     color: "#0f172a",
...
//                 <button
//                   onClick={() => alert("Recording flow not implemented yet.")}
...
//   const steps = ["Upload", "Transcribe", "Review", "Finalize"];
//   return (
//     <div
...
//                 style={{
//                   backgroundColor: "#eef4ff", // pale blue
//                   color: "#2f59b0",
...
//     tone === "draft"
//       ? {
//           backgroundColor: "#e9f1ff", // pale blue pill
//           color: "#2f59b0",
//           border: "1px solid #a3c4ff",
//         }
//       : {
//           backgroundColor: "#ecfdf3", // pale green pill
//           color: "#039855",
